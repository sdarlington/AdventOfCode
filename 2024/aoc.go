...
//   fmt.Println("Part 2: ", day06.Part2("day06/input.txt"))
  ...
  fmt.Println("Day 9")
  fmt.Println("Part 1: ", day09.Part1("day09/input.txt"))
	//fmt.Println("Part 2: ", day09.Part2("day09/input.txt"))

  fmt.Println("***")

//   fmt.Println("Day 10")
//   fmt.Println("Part 1: ", day10.Part1("day10/input.txt"))
//   fmt.Println("Part 2: ", day10.Part2("day10/input.txt"))

  fmt.Println("***")

  fmt.Println("Day 11")
  fmt.Println("Part 1: ", day11.Part1("day11/input.txt"))
//   fmt.Println("Part 2: ", day11.Part2("day11/input.txt"))

	fmt.Println("***")

	fmt.Println("Day 14")
	fmt.Println("Part 1: ", day14.Part1("day14/input.txt"))

	fmt.Println("***")

	fmt.Println("Day 17")

	fmt.Println("Part 1: ", day17.Part1("day17/input.txt"))

	fmt.Println("***")

	fmt.Println("Day 22")
	fmt.Println("Part 1: ", day22.Part1("day22/input.txt"))
